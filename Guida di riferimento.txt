...
19. **Pre-filtering (eliminare candidati ovviamente diversi)**
    ...
    - **Fourier Descriptors**: calcola i primi N coefficienti FFT della curva con `numpy.fft.fft()` e confronta le distanze euclidee tra i descrittori
    - Tieni solo i top-3 candidati per il DTW completo
