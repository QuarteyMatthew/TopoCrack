...
6. **Binarizzazione con soglia automatica di Otsu**

   - Libreria: `OpenCV`
   - Funzione: `cv2.threshold(closed_img_1, 0, 255, cv2.THRESH_BINARY + cv2.THRESH_OTSU)`

7. **Chiusura morfologica (closing)**
   - Libreria: `OpenCV`
...
8. **Skeletonization (assottigliamento a 1 pixel)**
...
9. **Estrazione del ramo principale (path più lungo)**
...
10. **Ricampionamento a N punti equidistanti**
...
12. **Rotazione (allineamento asse con PCA sull'intera nuvola di punti)**
...
13. **Normalizzazione della scala**
...
14. **Gestione dell'ambiguità inizio/fine**
...
18. **Conversione tratti costieri in array di punti normalizzati**
...
19. **Costruzione dell'indice del database**
...
20. **Pre-filtering (eliminare candidati ovviamente diversi)**
...
24. **Gestione immagini delle coste (per la visualizzazione)**
...
28. **Visualizzazione risultati affiancati**
...
29. **Gestione degli stati dell'app**
